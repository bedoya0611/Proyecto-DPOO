...
public class PanelMenuUsuario extends JPanel{
	...
	InterfazUsuario padre;
	
    public PanelMenuUsuario(InterfazUsuario padre) {
    	this.padre = padre;
        ...
        JButton btnRegistrarPieza = createButton("Piezas exhibidas");
        btnRegistrarPieza.setActionCommand("Exhibidas");
        JButton btnConfirmarVenta = createButton("Piezas disponibles");
        btnConfirmarVenta.setActionCommand("Disponibles");
        JButton btnConsultarComprador = createButton("Comprar pieza");
        btnConsultarComprador.setActionCommand("Comprar");
        JButton btnVerificarComprador = createButton("Participar en Subasta");
        btnVerificarComprador.setActionCommand("Participar");
